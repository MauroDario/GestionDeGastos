...
namespace GestionDeGastos.Controllers
{
    public class TipoCuentasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Descripcion")] TipoCuenta tipoCuenta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Descripcion")] TipoCuenta tipoCuenta)
        {
            if (ModelState.IsValid)
            {
